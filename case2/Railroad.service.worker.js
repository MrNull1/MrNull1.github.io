...
/** @type {string} */
const CACHE_VERSION = '1734120048|10113642448';
/** @type {string} */
const CACHE_PREFIX = 'Railroad-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Railroad.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Railroad.html","Railroad.js","Railroad.offline.html","Railroad.icon.png","Railroad.apple-touch-icon.png","Railroad.worker.js","Railroad.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Railroad.wasm","Railroad.pck"];
